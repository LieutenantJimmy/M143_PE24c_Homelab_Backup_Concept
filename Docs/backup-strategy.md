...
*Note: VMs were categorized by criticallity to the Network and or HomeLab, Critical/High Priority tier may cause a Ripple effect and take down the entire network and/or has no failover replacement.
